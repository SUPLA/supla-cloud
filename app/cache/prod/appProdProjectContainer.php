...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['accessid_manager'] = new \AppBundle\Model\AccessIdManager($this->get('translator.default'), $this->get('doctrine'), $this->get('security.context'));
    }
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 3306, 'dbname' => 'supla', 'user' => 'supla', 'password' => 'jbpH76CAEUuu2pUq', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_827f66965b44525c5faaf64e11ef2dcf39b1964a24be7288d9ad2468495b2c18');
        return $instance;
    }
    ...
    {
        return $this->services['iodevice_manager'] = new \AppBundle\Model\IODeviceManager($this->get('translator.default'), $this->get('doctrine'), $this->get('security.context'), $this->get('templating'));
    }
    ...
    {
        return $this->services['location_manager'] = new \AppBundle\Model\LocationManager($this->get('translator.default'), $this->get('doctrine'), $this->get('security.context'));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'form_themes' => array(0 => 'form_div_layout.html.twig', 1 => 'AppBundle:Form:fields.html.twig'), 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape' => array(0 => 'Symfony\\Bundle\\TwigBundle\\TwigDefaultEscapingStrategy', 1 => 'guess'), 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array()));
