...
\t\t<script src=\"";
        ...
        if ($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "user", array())) {
            // line 26
            echo "\t\t\t";
            if (((($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "_loc_list") || ($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "_aid_list")) || ($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "_iodev_item"))) {
                // line 27
                echo "\t\t\t\t<script src=\"";
...
\t\t\t";
            ...
            // line 32
            echo "\t\t\t";
            if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "_iodev_list")) {
                // line 33
                echo "\t\t\t\t<script src=\"";
...
\t
    ...
    <body ";
        // line 56
        if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "_auth_login")) {
            echo " class=\"login\" ";
        }
        echo " ";
        if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "_iodev_item")) {
            echo " class=\"device-details\" ";
        }
        // line 57
        echo "\t";
        if ((array_key_exists("homepage_viewed", $context) && ((isset($context["homepage_viewed"]) ? $context["homepage_viewed"] : null) == false))) {
...
\t\t\t\t  <li ";
            // line 76
            if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "_homepage")) {
                echo " class=\"active\" ";
            }
...
\t\t\t\t  <li ";
            // line 77
            if (((($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "_iodev_list") || ($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "_iodev_item")) || ($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "_iodev_channel_item_edit"))) {
                echo " class=\"active\" ";
            }
            echo "><a class=\"nav-link\" href=\"";
...
\t\t\t\t  <li ";
            // line 78
            if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "_loc_list")) {
                echo " class=\"active\" ";
            }
            echo "><a class=\"nav-link\" href=\"";
...
\t\t\t\t  <li ";
            // line 79
            if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "_aid_list")) {
                echo " class=\"active\" ";
            }
            echo "><a class=\"nav-link\" href=\"";
...
\t\t\t\t\t\t<a href=\"#\" class=\"dropdown-toggle\" data-toggle=\"dropdown\">";
            // line 81
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "security", array()), "token", array()), "user", array()), "email", array()), "html", null, true);
