...
\t<li><strong>";
        ...
        echo "</strong> ";
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["user"]) ? $context["user"] : null), "lastlogin", array()), "Y-m-d H:m:s"), "html", null, true);
        echo "</li>
\t<li><strong>";
        // line 12
        echo $this->env->getExtension('translator')->getTranslator()->trans("Last logged IP", array(), "messages");
        echo "</strong> ";
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["user"]) ? $context["user"] : null), "lastipv4", array()), "html", null, true);
        echo "</li>
</ul>
</div>
