...
";
    ...
    public function block_google_recaptcha_widget($context, array $blocks = array())
    {
        ...
        // line 14
        echo "        ";
        if ($this->getAttribute($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "vars", array()), "google_recaptcha_enabled", array())) {
            // line 15
            echo "            ";
            if ($this->getAttribute((isset($context["attr"]) ? $context["attr"] : null), "options", array(), "any", true, true)) {
                ...
                // line 17
                echo twig_jsonencode_filter($this->getAttribute((isset($context["attr"]) ? $context["attr"] : null), "options", array()));
                echo "
                </script>
            ";
            }
            // line 20
            echo "            <script src=\"";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "vars", array()), "url_challenge", array()), "html", null, true);
            echo "\" type=\"text/javascript\"></script>
            <noscript>
                <iframe src=\"";
            // line 22
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "vars", array()), "url_noscript", array()), "html", null, true);
