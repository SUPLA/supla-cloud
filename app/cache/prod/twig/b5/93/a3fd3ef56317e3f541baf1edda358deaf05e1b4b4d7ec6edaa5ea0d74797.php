...
\t\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable(twig_reverse_filter($this->env, (isset($context["accessids"]) ? $context["accessids"] : null)));
        foreach ($context['_seq'] as $context["_key"] => $context["aid"]) {
            ...
            echo "\" class=\"item ";
            if (($this->getAttribute($context["aid"], "id", array()) == (isset($context["aid_selected"]) ? $context["aid_selected"] : null))) {
                echo "selected";
            }
            echo " ";
