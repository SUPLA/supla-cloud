...
class __TwigTemplate_af9de0ca9e412138de59891478d1b87a2478acc4463520a915ae0027da6ddc67 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "session", array()), "flashbag", array()), "get", array(0 => (isset($context["msgtype"]) ? $context["msgtype"] : null)), "method"));
        foreach ($context['_seq'] as $context["_key"] => $context["flashMessage"]) {
            ...
            echo "',
                    type: '";
            // line 6
            if (((isset($context["msgtype"]) ? $context["msgtype"] : null) == "warning")) {
            } else {
                echo twig_escape_filter($this->env, (isset($context["msgtype"]) ? $context["msgtype"] : null), "html", null, true);
            }
            echo "'
               });
