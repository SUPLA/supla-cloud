...
class __TwigTemplate_d46ca1664b8eb5f7ead5cfa9fea44f259208fd158017ac372064fbafb4ed388c extends Twig_Template
{
    ...
    public function block_content($context, array $blocks = array())
    {
        ...
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["iodevice"]) ? $context["iodevice"] : $this->getContext($context, "iodevice")), "id", array()), "html", null, true);
        echo "\" data-item-path=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_iodev_item", array("id" => $this->getAttribute((isset($context["iodevice"]) ? $context["iodevice"] : $this->getContext($context, "iodevice")), "id", array()))), "html", null, true);
        echo "\">
\t<div class=\"container\">
\t\t<div class=\"supla-route\">
\t\t\t<div id=\"dot1\" class=\"dot1 ";
        // line 7
        if (($this->getAttribute((isset($context["iodevice"]) ? $context["iodevice"] : $this->getContext($context, "iodevice")), "enabled", array()) == false)) {
            echo " red ";
        }
        echo "\" data-id=\"";
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["iodevice"]) ? $context["iodevice"] : $this->getContext($context, "iodevice")), "id", array()), "html", null, true);
...
\t\t\t<div class=\"dot2 ";
        // line 9
        if (($this->getAttribute($this->getAttribute((isset($context["iodevice"]) ? $context["iodevice"] : $this->getContext($context, "iodevice")), "location", array()), "enabled", array()) == false)) {
            echo " red ";
        }
        echo "\">
\t\t\t</div>
\t\t\t<div class=\"dot3 ";
        // line 11
        if (((isset($context["aid_enabled"]) ? $context["aid_enabled"] : $this->getContext($context, "aid_enabled")) == false)) {
            echo " red ";
        }
        echo "\">
\t\t\t</div>
...
\t\t\t\t\t\t<li><strong>";
        // line 19
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["iodevice"]) ? $context["iodevice"] : $this->getContext($context, "iodevice")), "name", array()), "html", null, true);
        echo "</strong></li>
\t\t\t\t\t\t<li>";
        // line 20
        echo $this->env->getExtension('translator')->getTranslator()->trans("GUID", array(), "messages");
        echo " <strong>";
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["iodevice"]) ? $context["iodevice"] : $this->getContext($context, "iodevice")), "guidstring", array()), "html", null, true);
        echo "</strong></li>
\t\t\t\t\t\t<li>";
        // line 21
        echo $this->env->getExtension('translator')->getTranslator()->trans("Registred", array(), "messages");
        echo " <strong>";
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["iodevice"]) ? $context["iodevice"] : $this->getContext($context, "iodevice")), "regdate", array()), "d.m.Y H:m"), "html", null, true);
        echo "</strong></li>
\t\t\t\t\t\t<li>";
        // line 22
        echo $this->env->getExtension('translator')->getTranslator()->trans("Last connected", array(), "messages");
        echo " <strong>";
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["iodevice"]) ? $context["iodevice"] : $this->getContext($context, "iodevice")), "lastconnected", array()), "d.m.Y H:m"), "html", null, true);
        echo "</strong></li>
...
\t\t\t\t\t\t<textarea id=\"comment_value\" rows=\"2\" cols=\"27\" placeholder=\"";
        ...
        echo "\">";
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["iodevice"]) ? $context["iodevice"] : $this->getContext($context, "iodevice")), "comment", array()), "html", null, true);
...
\t\t\t\t<div data-preloader=\"set-enabled-pl\" class=\"btn btn-default btn-disable\" ";
        // line 31
        if (($this->getAttribute((isset($context["iodevice"]) ? $context["iodevice"] : $this->getContext($context, "iodevice")), "enabled", array()) == true)) {
            echo "style=\"display: none;\"";
        }
        echo "><strong>";
...
\t\t\t\t\t<a href=\"";
        // line 41
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_loc_item", array("id" => $this->getAttribute($this->getAttribute((isset($context["iodevice"]) ? $context["iodevice"] : $this->getContext($context, "iodevice")), "location", array()), "id", array()))), "html", null, true);
        echo "\" class=\"item  ";
        if ($this->getAttribute($this->getAttribute((isset($context["iodevice"]) ? $context["iodevice"] : $this->getContext($context, "iodevice")), "location", array()), "enabled", array())) {
            echo "enable";
        } else {
            echo "disabled";
        }
...
\t\t\t\t\t<span class=\"aid\">ID<strong>";
        // line 42
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["iodevice"]) ? $context["iodevice"] : $this->getContext($context, "iodevice")), "location", array()), "id", array()), "html", null, true);
        echo "</strong></span> <br />
\t\t\t\t\t<span class=\"acaption\">Caption<br />
\t\t\t\t\t<strong><span class=\"caption_value\">";
        // line 44
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["iodevice"]) ? $context["iodevice"] : $this->getContext($context, "iodevice")), "location", array()), "caption", array()), "html", null, true);
        echo "</span></strong><br />
\t\t\t\t\t<span class=\"apassword\">Password<br />
\t\t\t\t\t<strong><span class=\"password_value\">";
        // line 46
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["iodevice"]) ? $context["iodevice"] : $this->getContext($context, "iodevice")), "location", array()), "password", array()), "html", null, true);
        echo "</span></strong><br />
\t\t\t\t\t";
        // line 47
        if ($this->getAttribute($this->getAttribute((isset($context["iodevice"]) ? $context["iodevice"] : $this->getContext($context, "iodevice")), "location", array()), "enabled", array())) {
...
\t\t\t\t\t  ";
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute((isset($context["iodevice"]) ? $context["iodevice"] : $this->getContext($context, "iodevice")), "location", array()), "accessIds", array()));
...
\t\t\t<a href=\"";
        // line 104
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_iodev_item_delete", array("id" => $this->getAttribute((isset($context["iodevice"]) ? $context["iodevice"] : $this->getContext($context, "iodevice")), "id", array()))), "html", null, true);
