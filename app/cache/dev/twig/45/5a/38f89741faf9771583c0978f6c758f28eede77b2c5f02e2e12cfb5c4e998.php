...
class __TwigTemplate_455a38f89741faf9771583c0978f6c758f28eede77b2c5f02e2e12cfb5c4e998 extends Twig_Template
{
  ...
  <div id=\"accessid-detail\" data-id=\"";
        // line 3
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["accessid"]) ? $context["accessid"] : $this->getContext($context, "accessid")), "id", array()), "html", null, true);
        echo "\" data-item-path=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_aid_item", array("id" => $this->getAttribute((isset($context["accessid"]) ? $context["accessid"] : $this->getContext($context, "accessid")), "id", array()))), "html", null, true);
        echo "\">
...
\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"caption\" placeholder=\"";
        ...
        echo $this->env->getExtension('translator')->getTranslator()->trans("Caption", array(), "messages");
        echo "\" value=\"";
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["accessid"]) ? $context["accessid"] : $this->getContext($context, "accessid")), "caption", array()), "html", null, true);
        echo "\">
...
\t\t\t\t\t\t\t\t<input type=\"text\" id=\"password\" class=\"form-control\" placeholder=\"";
        ...
        echo $this->env->getExtension('translator')->getTranslator()->trans("Password", array(), "messages");
        echo "\" value=\"";
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["accessid"]) ? $context["accessid"] : $this->getContext($context, "accessid")), "password", array()), "html", null, true);
        echo "\">
\t\t\t\t\t\t\t\t<span class=\"input-group-btn\">
...
\t\t\t\t<div data-preloader=\"set-enabled-pl\" class=\"btn btn-default btn-enable\" ";
        // line 40
        if (($this->getAttribute((isset($context["accessid"]) ? $context["accessid"] : $this->getContext($context, "accessid")), "enabled", array()) == false)) {
...
\t\t\t\t<div data-preloader=\"set-enabled-pl\" class=\"btn btn-default btn-disable\" ";
        // line 41
        if (($this->getAttribute((isset($context["accessid"]) ? $context["accessid"] : $this->getContext($context, "accessid")), "enabled", array()) == true)) {
            echo "style=\"display: none;\"";
        }
        echo "><strong>";
...
\t\t\t<a href=\"";
        // line 102
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_aid_item_delete", array("id" => $this->getAttribute((isset($context["accessid"]) ? $context["accessid"] : $this->getContext($context, "accessid")), "id", array()))), "html", null, true);
