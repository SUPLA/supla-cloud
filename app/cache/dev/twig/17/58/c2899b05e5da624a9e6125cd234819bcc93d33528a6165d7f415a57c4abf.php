...
\t\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable(twig_reverse_filter($this->env, (isset($context["locations"]) ? $context["locations"] : $this->getContext($context, "locations"))));
        foreach ($context['_seq'] as $context["_key"] => $context["loc"]) {
            ...
            echo "\" class=\"item ";
            if (($this->getAttribute($context["loc"], "id", array()) == (isset($context["loc_selected"]) ? $context["loc_selected"] : $this->getContext($context, "loc_selected")))) {
                echo "selected";
            }
            echo " ";
