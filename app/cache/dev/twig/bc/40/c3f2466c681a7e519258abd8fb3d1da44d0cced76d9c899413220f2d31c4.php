...
class __TwigTemplate_bc40c3f2466c681a7e519258abd8fb3d1da44d0cced76d9c899413220f2d31c4 extends Twig_Template
{
    ...
    public function block_location_details($context, array $blocks = array())
    {
        ...
        echo "\" data-item-path=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_loc_item", array("id" => $this->getAttribute((isset($context["location"]) ? $context["location"] : $this->getContext($context, "location")), "id", array()))), "html", null, true);
        echo "\">
...
\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"caption\" placeholder=\"";
        ...
        echo $this->env->getExtension('translator')->getTranslator()->trans("Caption", array(), "messages");
        echo "\" value=\"";
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["location"]) ? $context["location"] : $this->getContext($context, "location")), "caption", array()), "html", null, true);
        echo "\">
...
\t\t\t\t\t\t\t\t<input type=\"text\" id=\"password\" class=\"form-control\" placeholder=\"";
        ...
        echo $this->env->getExtension('translator')->getTranslator()->trans("Password", array(), "messages");
        echo "\" value=\"";
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["location"]) ? $context["location"] : $this->getContext($context, "location")), "password", array()), "html", null, true);
        echo "\">
\t\t\t\t\t\t\t\t<span class=\"input-group-btn\">
...
\t\t\t\t<div data-preloader=\"set-enabled-pl\" class=\"btn btn-default btn-enable\" ";
        // line 38
        if (($this->getAttribute((isset($context["location"]) ? $context["location"] : $this->getContext($context, "location")), "enabled", array()) == false)) {
...
\t\t\t\t<div data-preloader=\"set-enabled-pl\" class=\"btn btn-default btn-disable\" ";
        // line 39
        if (($this->getAttribute((isset($context["location"]) ? $context["location"] : $this->getContext($context, "location")), "enabled", array()) == true)) {
            echo "style=\"display: none;\"";
        }
        echo "><strong>";
...
\t\t\t\t ";
        // line 104
        if (twig_length_filter($this->env, (isset($context["iodevices"]) ? $context["iodevices"] : $this->getContext($context, "iodevices")))) {
            // line 105
            echo "\t\t\t\t\t ";
            $context['_parent'] = (array) $context;
...
\t\t\t<a href=\"";
        // line 141
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_loc_item_delete", array("id" => $this->getAttribute((isset($context["location"]) ? $context["location"] : $this->getContext($context, "location")), "id", array()))), "html", null, true);
