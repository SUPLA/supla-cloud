...
class __TwigTemplate_11064952ed0fbd979c17dbdde8877a08844831c5bb24e527766af3ada2e79f3d extends Twig_Template
{
    ...
    <h5>";
        ...
        echo ": ";
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["channel"]) ? $context["channel"] : $this->getContext($context, "channel")), "channelnumber", array()), "html", null, true);
        echo "</h5>
    <h5>";
        // line 8
        echo $this->env->getExtension('translator')->getTranslator()->trans("Device GUID", array(), "messages");
        echo ": <a href=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_iodev_item", array("id" => $this->getAttribute($this->getAttribute((isset($context["channel"]) ? $context["channel"] : $this->getContext($context, "channel")), "iodevice", array()), "id", array()))), "html", null, true);
        echo "\">";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["channel"]) ? $context["channel"] : $this->getContext($context, "channel")), "iodevice", array()), "guidstring", array()), "html", null, true);
        echo "</a></h5>
    <h5>";
        // line 9
        ...
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_iodev_item", array("id" => $this->getAttribute($this->getAttribute((isset($context["channel"]) ? $context["channel"] : $this->getContext($context, "channel")), "iodevice", array()), "id", array()))), "html", null, true);
        echo "\">";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["channel"]) ? $context["channel"] : $this->getContext($context, "channel")), "iodevice", array()), "name", array()), "html", null, true);
        echo "</a></h5>
    <h5>";
        // line 10
        echo $this->env->getExtension('translator')->getTranslator()->trans("Type", array(), "messages");
        echo ": ";
        echo twig_escape_filter($this->env, (isset($context["channel_type"]) ? $context["channel_type"] : $this->getContext($context, "channel_type")), "html", null, true);
        echo "</h5>
    ";
        // line 11
        if (((isset($context["show_sensorstate"]) ? $context["show_sensorstate"] : $this->getContext($context, "show_sensorstate")) == true)) {
            // line 12
    ...
    ";
        ...
        // line 14
        echo "    ";
        if (((isset($context["show_temperature"]) ? $context["show_temperature"] : $this->getContext($context, "show_temperature")) == true)) {
            // line 15
