...
class Version20170126233449 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE supla_schedule (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, channel_id INT NOT NULL, cron_expression VARCHAR(100) NOT NULL, action INT NOT NULL, action_param VARCHAR(255) DEFAULT NULL, mode VARCHAR(15) NOT NULL, date_start DATETIME NOT NULL, date_end DATETIME DEFAULT NULL, enabled TINYINT(1) NOT NULL, next_calculation_date DATETIME, INDEX IDX_323E8ABEA76ED395 (user_id), INDEX IDX_323E8ABE72F5A1AA (channel_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
