...
class Version20181129100106 extends NoWayBackMigration {
    public function migrate() {
        $this->addSql('ALTER TABLE supla_user ADD uuid VARCHAR(36) DEFAULT NULL');
        $this->addSql('ALTER TABLE supla_user ADD random_id VARCHAR(200) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE supla_user CHANGE uuid uuid VARCHAR(36) NOT NULL');
        $this->addSql('ALTER TABLE supla_user CHANGE random_id random_id VARCHAR(200) NOT NULL');
