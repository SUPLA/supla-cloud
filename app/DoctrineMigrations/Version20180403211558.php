...
class Version20180403211558 extends AbstractMigration {
    public function up(Schema $schema) {
        ...
        $this->addSql('CREATE TABLE supla_audit (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, action INT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:utcdatetime)\', successful TINYINT(1) DEFAULT \'1\' NOT NULL, ipv4 INT UNSIGNED DEFAULT NULL, text_param1 VARCHAR(255) DEFAULT NULL, INDEX IDX_EFE348F4A76ED395 (user_id), INDEX supla_audit_ipv4_idx (ipv4), INDEX supla_audit_created_at_idx (created_at), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
