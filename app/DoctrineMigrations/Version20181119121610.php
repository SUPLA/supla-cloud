 ...
 */
class Version20181119121610 extends NoWayBackMigration
{
    public function migrate() {
        ...
        $this->addSql('CREATE TABLE supla_amazon_alexa (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, reg_date DATETIME NOT NULL COMMENT \'(DC2Type:utcdatetime)\', access_token VARCHAR(1024) NOT NULL, expires_at DATETIME NOT NULL COMMENT \'(DC2Type:utcdatetime)\', refresh_token VARCHAR(1024) NOT NULL, region VARCHAR(5) DEFAULT NULL, endpoint_scope VARCHAR(36) NOT NULL, UNIQUE INDEX UNIQ_290228F0A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
