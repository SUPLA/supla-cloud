...
class Version20180403175932 extends AbstractMigration {
    public function up(Schema $schema) {
        ...
        $this->addSql('ALTER TABLE supla_iodevice CHANGE reg_date reg_date DATETIME NOT NULL COMMENT \'(DC2Type:utcdatetime)\', CHANGE last_connected last_connected DATETIME DEFAULT NULL COMMENT \'(DC2Type:utcdatetime)\', CHANGE last_ipv4 last_ipv4 INT DEFAULT NULL, CHANGE software_version software_version VARCHAR(10) NOT NULL');
