...
class Version20191226160845 extends NoWayBackMigration {
    public function migrate() {
        ...
        $this->addSql("UPDATE supla_dev_channel c SET user_icon_id=(SELECT id FROM supla_user_icons WHERE func=$ic AND user_id = c.user_id AND image1=(SELECT image1 FROM supla_user_icons WHERE id=c.user_icon_id)) WHERE func=$ic AND user_icon_id IS NOT NULL;");
