...
class Version20180717094843 extends AbstractMigration {
    public function up(Schema $schema) {
        ...
        $this->addSql('ALTER TABLE supla_oauth_clients ADD user_id INT DEFAULT NULL, ADD name VARCHAR(255) DEFAULT NULL, ADD description VARCHAR(255) DEFAULT NULL, ADD homepage VARCHAR(255) DEFAULT NULL, ADD is_public TINYINT(1) NOT NULL');
