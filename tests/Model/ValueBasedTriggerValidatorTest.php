...
class ValueBasedTriggerValidatorTest extends TestCase {
    ...
    public static function validTriggers() {
        return [
            ...
            [ChannelFunction::GENERAL_PURPOSE_TEXT(), '{"on_change_to": {"eq": "desired text"}}'],
            [ChannelFunction::GENERAL_PURPOSE_TEXT(), '{"on_change": {"duration_sec": 60}}'],
    ...
    public static function invalidTriggers() {
        return [
            ...
            [ChannelFunction::GENERAL_PURPOSE_TEXT(), '{"on_change_to": {"eq": 10}}', 'Text comparison value must be a string'],
            [ChannelFunction::THERMOMETER(), '{"on_change": {"unicorn": "rainbow"}}', 'Unknown trigger keys'],
