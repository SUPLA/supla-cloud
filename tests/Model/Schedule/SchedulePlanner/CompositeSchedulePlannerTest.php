...
//        $this->assertContains('2025-03-30T03:30:00+02:00', $runDates);
    ...
    public function testCalculatingCronExpressionWhenDstChangesForwardWithSunriseSchedule() {
        ...
        $this->assertContains('2025-03-27T05:31:00+01:00', $runDates);
        $this->assertContains('2025-03-28T05:31:00+01:00', $runDates);
        $this->assertContains('2025-03-29T05:29:00+01:00', $runDates);
        $this->assertContains('2025-03-30T06:27:00+02:00', $runDates);
        $this->assertContains('2025-03-31T06:24:00+02:00', $runDates);
        $this->assertContains('2025-04-01T06:22:00+02:00', $runDates);
        $this->assertNotContains('2025-03-30T05:31:00+02:00', $runDates);
        $this->assertNotContains('2025-03-30T05:29:00+01:00', $runDates);
    }
...
//        $this->assertContains('2018-11-04T01:30:00-06:00', $runDates);
    ...
    public function testCalculatingNextRunDateForComplexConfigs($startDate, $config, $expectedNextRunDate, $timezone = 'Europe/Warsaw') {
        ...
        $nextExecution = $this->planner->calculateNextScheduleExecution($schedule, $startDate);
        $actualNextRunDate = $formatter($nextExecution);
        $this->assertEquals($expectedNextRunDate, $actualNextRunDate);
    }
