...
class Version20260611125123 extends NoWayBackMigration {
    public function migrate(): void {
        ...
        $this->addSql('CREATE SEQUENCE supla_energy_tariff_profile_assignment_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE TABLE supla_energy_tariff_profile_assignment (id BIGINT NOT NULL, profile_id BIGINT NOT NULL, channel_id INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE supla_energy_tariff_profile_price_item (id BIGINT NOT NULL, price_period_id BIGINT NOT NULL, component_code VARCHAR(100) NOT NULL, zone_code VARCHAR(100) DEFAULT NULL, amount NUMERIC(12, 6) NOT NULL, unit VARCHAR(20) NOT NULL, currency VARCHAR(10) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE supla_energy_tariff_profile_price_period (id BIGINT NOT NULL, tariff_period_id BIGINT NOT NULL, name VARCHAR(255) NOT NULL, billing_period_start_day INT NOT NULL, valid_from TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, valid_to TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE supla_energy_tariff_profile_tariff_period (id BIGINT NOT NULL, profile_id BIGINT NOT NULL, tariff_id BIGINT NOT NULL, valid_from TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, valid_to TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
