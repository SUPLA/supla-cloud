...
class Version20260611104850 extends NoWayBackMigration {
    public function migrate(): void {
        ...
        $this->addSql('CREATE TABLE supla_energy_tariff_profile_assignment (id BIGINT AUTO_INCREMENT NOT NULL, profile_id BIGINT NOT NULL, channel_id INT NOT NULL, INDEX idx_tariff_profile_assignment_profile (profile_id), UNIQUE INDEX uniq_tariff_profile_assignment_channel (channel_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE supla_energy_tariff_profile_price_item (id BIGINT AUTO_INCREMENT NOT NULL, price_period_id BIGINT NOT NULL, component_code VARCHAR(100) NOT NULL, zone_code VARCHAR(100) DEFAULT NULL, amount NUMERIC(12, 6) NOT NULL, unit VARCHAR(20) NOT NULL, currency VARCHAR(10) NOT NULL, INDEX IDX_9AC6D6BA6F3A4922 (price_period_id), INDEX idx_tariff_profile_price_item_component_zone (price_period_id, component_code, zone_code), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE supla_energy_tariff_profile_price_period (id BIGINT AUTO_INCREMENT NOT NULL, tariff_period_id BIGINT NOT NULL, name VARCHAR(255) NOT NULL, billing_period_start_day INT NOT NULL, valid_from DATETIME NOT NULL COMMENT \'(DC2Type:utcdatetime)\', valid_to DATETIME DEFAULT NULL COMMENT \'(DC2Type:utcdatetime)\', INDEX IDX_2B674158A3DDABB8 (tariff_period_id), INDEX idx_tariff_profile_price_period_time (tariff_period_id, valid_from, valid_to), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
