...
class DevicesFixture extends SuplaFixture {
    ...
    protected function createDeviceRgb(Location $location): IODevice {
        return $this->createDevice('RGB-801', $location, [
            [ChannelType::RGBLEDCONTROLLER, ChannelFunction::DIMMERANDRGBLIGHTING, ['flags' => ChannelFlags::RGBW_COMMANDS_SUPPORTED]],
...
//                            "auxThermometerChannelNo",
    ...
    public function createDeviceModbus(Location $location): IODevice {
        ...
        AnyFieldSetter::set($device, [
            'flags' => IoDeviceFlags::AUTOMATIC_FIRMWARE_UPDATE_SUPPORTED | IoDeviceFlags::FACTORY_RESET_SUPPORTED | IoDeviceFlags::SET_CFG_MODE_PASSWORD_SUPPORTED,
