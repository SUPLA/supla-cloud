...
class LocationController extends Controller
{
	...
	private function getLocationDetails($id) {
		...
		if ( $loc !== null ) {
			...
			return $this->get('templating')->render('AppBundle:Location:locdetails.html.twig',
					array('location' => $loc,
    ...
    public function listAction()
    {
    	...
    	return $this->render('AppBundle:Location:loclist.html.twig',
    ...
    public function newAction()
    {
    	...
    	if ( $user->getLimitLoc() > 0 
    		...
    		if ( $loc !== null ) {
    			...
    			$this->get('session')->getFlashBag()->add('success', array('title' => 'Success', 'message' => 'New location created'));
    		} else {
    ...
    public function itemDeleteAction($id)
    {
    	...
    	//TODO: !!!usunąc powiązane urządzenia!!!
    ...
    public function assignAidAction(Request $request, $id)
    {
    	...
    	return $this->render('AppBundle:Location:assignaid.html.twig',
    ...
    public function ajaxAssignAidList(Request $request, $id)
    {
    	...
    	if ( $loc !== null ) {
    		...
    		$html = $this->get('templating')->render('AppBundle:Location:assignaid.html.twig',
    				array('form' => $form->createView(),
    						'location' => $loc,
    ...
    public function ajaxSetEnabled(Request $request, $id, $enabled)
    {
    	...
    	return $this->ajaxItemEdit($loc,
    			$this->get('translator')->trans('Location has been '.($enabled == '1' ? 'enabled' : 'disabled')),
