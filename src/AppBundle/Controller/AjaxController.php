...
class AjaxController extends Controller
{
    ...
    public function lngsetAction(Request $request, $_loc)
    {
    	...
    	if ( in_array($_loc, array('en', 'pl_PL')) ) {
    ...
    /**
     * @Route("/serverctrl-sensorstate/{channel_id}", name="_ajax_serverctrl-sensorstate")
     */
    public function serverctrlSensorStateAction($channel_id)
    {
    
    	return AjaxController::jsonResponse(true, array('value' => 'Close'));
    }
    
    /**
     * @Route("/serverctrl-tempval/{channel_id}", name="_ajax_serverctrl-tempval")
     */
    public function serverctrlTempValAction($channel_id)
    {
    
    	return AjaxController::jsonResponse(true, array('value' => '21'));
    }
