<?php
/*
 src/AppBundle/Model/UserManager.php
...
class UserManager 
{
	...
	public function __construct($doctrine, $encoder_factory, $accessid_manager, $location_manager)
	{
		...
		$this->rep = $doctrine->getRepository('AppBundle:User');
    ...
    public function userByConfirmationToken($token)
    {
        ...
        return $this->rep->findOneBy(array('token' => $token, 'enabled' => 0, 'lastLogin' => null, 'passwordRequestedAt' => null));
    }
