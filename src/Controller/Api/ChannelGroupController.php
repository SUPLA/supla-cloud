...
use App\Model\Dependencies\ChannelGroupDependencies;
use App\Model\Transactional;
use App\Repository\ChannelGroupRepository;
use App\Serialization\RequestFiller\ChannelGroupRequestFiller;
...
class ChannelGroupController extends RestController {
    ...
    /** @return Collection|\App\Entity\Main\IODeviceChannelGroup[] */
