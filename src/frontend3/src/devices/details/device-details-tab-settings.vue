...
<script setup>
  import DeviceDetailsTabBasicSettings
    from "@/devices/details/device-details-tab-basic-settings.vue";
  ...
  import DeviceDetailsTabSettingsModbus
    from "@/devices/details/device-details-tab-settings-modbus.vue";
  import {computed, onMounted, ref} from "vue";
  import DeviceDetailsTabSettingsUserInterface
    from "@/devices/details/device-details-tab-settings-user-interface.vue";
  ...
  import DeviceDetailsTabSettingsUpdates
    from "@/devices/details/device-details-tab-settings-updates.vue";
  import DeviceDetailsTabSettingsDatetime
    from "@/devices/details/device-details-tab-settings-datetime.vue";
