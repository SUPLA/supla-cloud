...
<script setup>
  import DeviceEnterConfigurationModeButton
    from "@/devices/details/device-enter-configuration-mode-button.vue";
  ...
  import DeviceRemoteFactoryResetButton
    from "@/devices/details/device-remote-factory-reset-button.vue";
