...
<script>
  ...
  import ChannelParamsControllingthegateNumberOfOpencloseAttempts
    from "@/channels/params/channel-params-controllingthegate-number-of-openclose-attempts.vue";
  import ChannelParamsControllingthegateClosingRule
    from "@/channels/params/channel-params-controllingthegate-closing-rule.vue";
