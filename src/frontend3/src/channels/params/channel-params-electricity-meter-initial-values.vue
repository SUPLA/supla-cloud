...
<script>
  ...
  import ChannelParamsElectricityMeterInitialValue
    from "@/channels/params/channel-params-electricity-meter-initial-value.vue";
  import ModalConfirm from "@/common/modal-confirm.vue";

  export default {
        components: {
          ModalConfirm,
          ChannelParamsElectricityMeterInitialValue, ChannelParamsMeterInitialValuesMode},
        props: ['channel'],
        data() {
            return {
