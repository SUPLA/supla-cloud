...
<script>
  import ChannelReactionConditionChooser
    from "@/channels/reactions/channel-reaction-condition-chooser.vue";
  ...
  export default {
        ...
        methods: {
            ...
            addNewReaction() {
                return api.post(`channels/${this.owningChannel.id}/reactions?include=subject,owningChannel`, this.reaction)
                    .then((response) => {
            ...
            updateReaction() {
                return api.put(`channels/${this.owningChannel.id}/reactions/${this.item.id}?include=subject,owningChannel`, this.reaction)
                    .then((response) => {
            ...
            deleteReaction() {
                this.loading = true;
                api.delete_(`channels/${this.owningChannel.id}/reactions/${this.item.id}`)
