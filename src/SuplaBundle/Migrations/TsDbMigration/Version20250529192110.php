...
class Version20250529192110 extends NoWayBackMigration {
    public function migrate() {
        $this->addSql('CREATE TABLE supla_em_current_log (channel_id INT NOT NULL, date TIMESTAMPTZ(0) NOT NULL, phase_no SMALLINT NOT NULL, min NUMERIC(6, 3) NOT NULL, max NUMERIC(6, 3) NOT NULL, avg NUMERIC(6, 3) NOT NULL, PRIMARY KEY(channel_id, date, phase_no))');
        ...
        $this->addSql('CREATE TABLE supla_em_power_active_log (channel_id INT NOT NULL, date TIMESTAMPTZ(0) NOT NULL, phase_no SMALLINT NOT NULL, min NUMERIC(11, 5) NOT NULL, max NUMERIC(11, 5) NOT NULL, avg NUMERIC(11, 5) NOT NULL, PRIMARY KEY(channel_id, date, phase_no))');
        ...
        $this->addSql('CREATE TABLE supla_em_voltage_aberration_log (channel_id INT NOT NULL, date TIMESTAMPTZ(0) NOT NULL, phase_no SMALLINT NOT NULL, count_total INT NOT NULL, count_above INT NOT NULL, count_below INT NOT NULL, sec_above INT NOT NULL, sec_below INT NOT NULL, max_sec_above INT NOT NULL, max_sec_below INT NOT NULL, min_voltage NUMERIC(7, 2) NOT NULL, max_voltage NUMERIC(7, 2) NOT NULL, avg_voltage NUMERIC(7, 2) NOT NULL, measurement_time_sec INT NOT NULL, PRIMARY KEY(channel_id, date, phase_no))');
        ...
        $this->addSql('CREATE TABLE supla_em_voltage_log (channel_id INT NOT NULL, date TIMESTAMPTZ(0) NOT NULL, phase_no SMALLINT NOT NULL, min NUMERIC(5, 2) NOT NULL, max NUMERIC(5, 2) NOT NULL, avg NUMERIC(5, 2) NOT NULL, PRIMARY KEY(channel_id, date, phase_no))');
        ...
        $this->addSql('CREATE TABLE supla_gp_meter_log (channel_id INT NOT NULL, date TIMESTAMPTZ(0) NOT NULL, value DOUBLE PRECISION NOT NULL, PRIMARY KEY(channel_id, date))');
        ...
        $this->addSql('CREATE TABLE supla_ic_log (channel_id INT NOT NULL, date TIMESTAMPTZ(0) NOT NULL, counter BIGINT NOT NULL, calculated_value BIGINT NOT NULL, PRIMARY KEY(channel_id, date))');
        ...
        $this->addSql('CREATE TABLE supla_temperature_log (channel_id INT NOT NULL, date TIMESTAMPTZ(0) NOT NULL, temperature NUMERIC(8, 4) NOT NULL, PRIMARY KEY(channel_id, date))');
        ...
        $this->addSql('CREATE TABLE supla_temphumidity_log (channel_id INT NOT NULL, date TIMESTAMPTZ(0) NOT NULL, temperature NUMERIC(8, 4) NOT NULL, humidity NUMERIC(8, 4) NOT NULL, PRIMARY KEY(channel_id, date))');
        ...
        $this->addSql('CREATE TABLE supla_thermostat_log (channel_id INT NOT NULL, date TIMESTAMPTZ(0) NOT NULL, "on" BOOLEAN NOT NULL, measured_temperature NUMERIC(5, 2) NOT NULL, preset_temperature NUMERIC(5, 2) NOT NULL, PRIMARY KEY(channel_id, date))');
