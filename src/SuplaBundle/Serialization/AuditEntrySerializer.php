...
class AuditEntrySerializer extends AbstractSerializer {
     ...
     * @inheritdoc
     */
    protected function addExtraFields(array &$normalized, $auditEntry, array $context) {
        if (!ApiVersions::V2_4()->isRequestedEqualOrGreaterThan($context)) {
            $normalized['ipv4'] = ($normalized['ipv4'] ?? null) ? ip2long($normalized['ipv4']) : null;
        }
    }

    public function supportsNormalization($entity, $format = null) {
        return $entity instanceof AuditEntry;
    }
}
