<?php
/*
 src/SuplaBundle/Controller/AccessIDController.php
...
use SuplaBundle\Form\Type\AccessIdType;
...
class AccessIDController extends Controller
{
	...
	private function getAccessIdDetails($id) {
		...
		if ( $aid !== null ) {
			...
			return $this->get('templating')->render('SuplaBundle:AccessID:aiddetails.html.twig',
					array('accessid' => $aid,
    ...
    public function listAction()
    {
    	...
    	return $this->render('SuplaBundle:AccessID:aidlist.html.twig', 
    ...
    public function ajaxAssignLocList(Request $request, $id)
    {
    	...
    	if ( $aid !== null ) {
    		...
    		$html = $this->get('templating')->render('SuplaBundle:AccessID:assignloc.html.twig',
