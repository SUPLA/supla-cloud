...
class SunriseSunsetSchedulePlannerTest extends TestCase {
    ...
    public static function calculatingNextRunDateProvider() {
        return [
            ...
            ['2017-06-28 23:59', 'SS0 * * * *', '2017-06-29 16:57', 'Australia/Sydney'],
            ['2017-06-29 00:00', 'SS0 * * * *', '2017-06-29 16:58', 'Australia/Sydney'],
            ['2017-06-29 00:01', 'SS0 * * * *', '2017-06-29 16:58', 'Australia/Sydney'],
