...
class ChannelParamConfigTranslatorTest extends TestCase {
    ...
    public function paramsConfigsExamples() {
        ...
        return [
            ...
            [ChannelFunction::ELECTRICITYMETER(), [100, 123, 124, 'PLN', 'm3'], ['pricePerUnit' => 0.0123, 'impulsesPerUnit' => 124, 'currency' => 'PLN', 'initialValue' => 100, 'unit' => 'm3'], ChannelType::IMPULSECOUNTER()],
            [ChannelFunction::ELECTRICITYMETER(), [null, 123, null, 'PLN'], ['pricePerUnit' => 0.0123, 'currency' => 'PLN'], ChannelType::ELECTRICITYMETER()],
            [ChannelFunction::GASMETER(), [111, 123, 124, 'PLN', 'm3'], ['pricePerUnit' => 0.0123, 'impulsesPerUnit' => 124, 'currency' => 'PLN', 'initialValue' => 111, 'unit' => 'm3'], ChannelType::IMPULSECOUNTER()],
            ...
            [ChannelFunction::WATERMETER(), [111, 123, 124, 'PLN', 'm3'], ['pricePerUnit' => 0.0123, 'impulsesPerUnit' => 124, 'currency' => 'PLN', 'initialValue' => 111, 'unit' => 'm3'], ChannelType::IMPULSECOUNTER()],
            [
