...
class SetRgbwParametersActionExecutorTest extends TestCase {
    ...
    public static function exampleRgbwParameters() {
        return [
            [['hue' => 0], '16711680,-1,-1,-1'],
            [['hue' => 0, 'color_brightness' => 0], '16711680,0,-1,-1'],
            [['color_brightness' => 33], '-1,33,-1,-1'],
            [['hue' => 'white', 'color_brightness' => 12], '16777215,12,-1,-1'],
            [['color' => '0xFF0000'], '16711680,-1,-1,-1'],
            [['rgb' => ['red' => 255, 'green' => 0, 'blue' => 0]], '16711680,100,-1,-1'],
            [['color' => '0xAA0000'], '11141120,-1,-1,-1'],
            [['color' => '0xAA0000', 'color_brightness' => 70], '11141120,70,-1,-1'],
            [['color' => '0xAA0000', 'brightness' => 70], '11141120,-1,70,-1'],
            [['rgb' => ['red' => 170, 'green' => 0, 'blue' => 0]], '11141120,67,-1,-1'],
            [['color' => '0xFF0000', 'brightness' => 40], '16711680,-1,40,-1'],
            [['rgb' => ['red' => 255, 'green' => 0, 'blue' => 0], 'brightness' => 40], '16711680,100,40,-1'],
            [['hsv' => ['hue' => 0, 'saturation' => 100, 'value' => 100]], '16711680,100,-1,-1'],
            [['hsv' => ['hue' => 0, 'saturation' => 100, 'value' => 60]], '10027008,60,-1,-1'],
            [['hsv' => ['hue' => 0, 'saturation' => 100, 'value' => 60]], '10027008,60,-1,-1'],
            [['color_brightness' => 40], '-1,40,-1,-1'],
            [['color' => 'random'], 'SET-RAND-RGBW-VALUE:1,1,1,-1,-1'],
            [['hue' => 'random', 'color_brightness' => 88], 'SET-RAND-RGBW-VALUE:1,1,1,88,-1'],
            [['color' => 'random', 'color_brightness' => 98], 'SET-RAND-RGBW-VALUE:1,1,1,98,-1'],
            [['hue' => 0, 'color_brightness' => 0, 'turnOnOff' => true], '16711680,0,-1,3', ChannelFunction::DIMMERANDRGBLIGHTING],
            [['hue' => 0, 'turnOnOff' => 2], '16711680,-1,-1,2', ChannelFunction::DIMMERANDRGBLIGHTING],
            [['hue' => 0, 'turnOnOff' => 1], '16711680,-1,-1,1', ChannelFunction::DIMMERANDRGBLIGHTING],
            [['hue' => 0, 'turnOnOff' => true], '16711680,-1,-1,1', ChannelFunction::DIMMER],
            [['hue' => 0, 'turnOnOff' => 2], '16711680,-1,-1,1', ChannelFunction::DIMMER],
            [['hue' => 0, 'turnOnOff' => 23], '16711680,-1,-1,1', ChannelFunction::DIMMER],
            [['hue' => 0, 'turnOnOff' => true], '16711680,-1,-1,2', ChannelFunction::RGBLIGHTING],
            [['hue' => 0, 'turnOnOff' => 1], '16711680,-1,-1,2', ChannelFunction::RGBLIGHTING],
            [['hue' => 0, 'turnOnOff' => false], '16711680,-1,-1,0'],
        ];
    }
}
