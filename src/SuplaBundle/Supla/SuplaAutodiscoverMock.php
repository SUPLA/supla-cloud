...
class SuplaAutodiscoverMock extends SuplaAutodiscover {
        ...
        if (preg_match('#/users/?(.*)#', $endpoint, $match)) {
            ...
            return array_map(function ($cityId) {
                return [
                    ...
                    'weather' => [
                        'temp' => random_int(0, 3000) / 100,
                        'feelsLike' => random_int(0, 3000) / 100,
                        'pressure' => random_int(970, 1030),
                        'humidity' => random_int(20, 80),
                        'visibility' => random_int(500, 10000),
                        'windSpeed' => random_int(0, 100) / 10,
                        'windGust' => random_int(0, 100) / 10,
                        'clouds' => random_int(0, 100),
                        'rainMmh' => random_int(0, 50),
                        'snowMmh' => random_int(0, 50),
                        'airCo' => random_int(100, 1000) / 10,
                        'airNo' => random_int(100, 1000) / 10,
                        'airNo2' => random_int(100, 1000) / 10,
                        'airO3' => random_int(100, 1000) / 10,
                        'airPm10' => random_int(100, 1000) / 10,
                        'airPm25' => random_int(100, 1000) / 10,
                    ],
                ];
            }, $post['cityIds']);
    ...
    public static function sampleEspUpdate(array $data = []): array {
        $defaults = [
            ...
            'platform' => 1,
            'latest_software_version' => '2.7.' . random_int(0, 100),
            'fparam1' => 3,
            'fparam2' => 5,
            'fparam3' => 7,
            'fparam4' => 9,
