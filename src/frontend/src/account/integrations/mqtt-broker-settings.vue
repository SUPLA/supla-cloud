  ...
  export default {
        ...
        methods: {
            ...
            generateMqttPassword() {
                this.fetching = true;
                api.patch(`users/current`, {action: 'change:mqttBrokerPassword', password: this.password})
            ...
            enableMqttBrokerSupport() {
                this.fetching = true;
                return api.patch(`users/current`, {action: 'change:mqttBrokerEnabled', enabled: true})
                    .then((response) => this.generatedPassword = response.headers.get('SUPLA-MQTT-Password'))
            ...
            disableMqttBrokerSupport() {
                this.fetching = true;
                return api.patch(`users/current`, {action: 'change:mqttBrokerEnabled', enabled: false})
