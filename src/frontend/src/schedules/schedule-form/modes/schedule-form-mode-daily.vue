  ...
  <div>
      ...
      <div v-for="action in config[weekdayGroupIndex]" :key="action.tempId" class="schedule-action">
        <div class="schedule-action-row">
          ...
          <div class="schedule-action-buttons">
            <a class="remove-item-button" @click="removeItem(action)">
    ...
    <div class="form-group">
      ...
      <div class="btn-group btn-group-justified">
        <a class="btn btn-default btn-wrapped" @click="addAction('hour')">
          <i class="pe-7s-clock"></i>
          {{ $t('At specified time') }}
        </a>
        <a class="btn btn-default btn-wrapped" @click="addAction('sun')">
          <i class="pe-7s-sun"></i>
...
<script>
  import ScheduleFormModeDailyHour from '@/schedules/schedule-form/modes/schedule-form-mode-daily-hour.vue';
  import ScheduleFormModeDailySun from '@/schedules/schedule-form/modes/schedule-form-mode-daily-sun.vue';
  ...
  import ScheduleFormModeDailyDaySelector from '@/schedules/schedule-form/modes/schedule-form-mode-daily-day-selector.vue';
  import ChannelFunctionAction from '../../../common/enums/channel-function-action';

  export default {
    components: {
      ScheduleFormModeDailyDaySelector,
      ChannelActionChooser,
      ScheduleFormModeDailySun,
      ScheduleFormModeDailyHour,
    },
    props: ['value', 'subject'],
    data() {
      return {
