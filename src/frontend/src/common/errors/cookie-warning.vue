<template>
  <transition name="fade">
    <div v-if="shown" class="alert alert-warning cookie-warning">
      ...
      <a class="btn btn-default btn-xs pull-right" @click="agree()">{{ $t('I agree') }}</a>
      <regulations-modal v-if="regulationsShown" @confirm="regulationsShown = false"></regulations-modal>
    </div>
  </transition>
</template>
