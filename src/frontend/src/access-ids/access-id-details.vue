          ...
          <div class="row">
                ...
                <div class="hover-editable text-left">
                  <dl>
                    ...
                    <dt class="text-center">
                      <toggler v-model="accessId.enabled" @update:model-value="accessIdChanged()"></toggler>
                    </dt>
                    <dd>{{ $t('Caption') }}</dd>
                    <dt>
                      <input v-model="accessId.caption" type="text" class="form-control" @keydown="accessIdChanged()" />
                    </dt>
                    <dd>{{ $t('Password') }}</dd>
                    <dt>
                      <password-display :password="accessId.password" editable="true" @change="updatePassword($event)"></password-display>
                    </dt>
                  </dl>
                </div>
              </div>
            ...
            <div class="col-sm-6">
              <div class="details-page-block">
                ...
                <date-range-picker v-model="activeDateRange" @input="accessIdChanged()"></date-range-picker>
              </div>
            </div>
          </div>
              ...
              <div class="details-page-block">
                ...
                <div class="form-group text-center">
                  <label>
                    <label class="checkbox2 checkbox2-grey">
                      <input v-model="useWorkingSchedule" type="checkbox" @change="accessIdChanged()" />
                ...
                <transition-expand>
                  <week-schedule-selector
                    v-if="useWorkingSchedule"
                    v-model="activeHours"
                    class="mode-1-green"
                    @input="accessIdChanged()"
                  ></week-schedule-selector>
                </transition-expand>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="details-page-block">
                ...
                <table v-if="accessId.locations.length" class="table table-hover">
                  <thead>
                    <tr>
                      <th>ID</th>
                      <th>{{ $t('Password') }}</th>
            ...
            <div class="col-sm-6">
              <div class="details-page-block">
                ...
                <table v-if="accessId.clientApps.length" class="table table-hover">
                  <thead>
                    <tr>
                      <th>ID</th>
                      <th>{{ $t('Caption') }}</th>
                  ...
                  <tbody>
                    <tr v-for="app in accessId.clientApps" :key="app.id">
                      <td>{{ app.id }}</td>
                      <td>{{ app.caption }}</td>
