<template>
  <div v-if="device.flags.pairingSubdevicesAvailable" class="d-flex align-items-center">
    <div v-if="lastPairingResult" class="text-center mr-2">
      <div class="small">
    ...
    <!-- i18n: ['subdevicePairingResult_REQUEST_SENT', 'subdevicePairingResult_DEVICE_NOT_SUPPORTED'] -->
  </div>
</template>
