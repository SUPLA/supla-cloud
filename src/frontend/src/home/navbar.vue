    ...
    <div class="container">
      ...
      <div :class="['collapse navbar-collapse', {in: !collapsed}]">
        <ul class="nav navbar-nav">
          <li>
            <router-link active-class="link-active" exact-active-class="active" :class="{active: subIsActive(['/devices', '/channels'])}" :to="{name: 'me'}">
          ...
          >
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                <a href="https://cloud.supla.org/apps" target="_blank">
            ...
            <ul class="dropdown-menu">
              <li>
                <router-link to="/account" class="text-center">
                  <span v-if="currentUserStore.username" class="username">{{ currentUserStore.username }}</span>
