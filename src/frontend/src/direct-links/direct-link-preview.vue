<template>
  <div class="alert alert-warning">
    ...
    <div class="form-group">
      ...
      <p>
        {{ $t('Make sure to save it in a secure place if you wish to access it in the future. The link won’t be again displayed after you leave this page.') }}
      </p>
    </div>
    <div class="form-group text-center">
      <a :href="url" target="_blank" class="btn btn-green">
    ...
    <ul class="nav nav-tabs">
      ...
      <li v-for="action in possibleAllowedActions" :key="action.id" :class="currentAction == action.nameSlug ? 'active' : ''">
