        ...
        data() {
            return {
                currencyCodes: [
                    ...
                    'VEF', 'VND', 'VUV', 'WST', 'XAF', 'XCD', 'XDR', 'XOF', 'XPF', 'XSU', 'XUA', 'YER', 'ZAR', 'ZMW', 'ZWL'],
            };
        },
        computed: {
            chosenCurrency: {
                get() {
                    return this.value ? {id: this.value, caption: this.value} : undefined;
                },
                set(value) {
            ...
            currencyCodesList() {
                return this.currencyCodes.map(code => ({id: code, caption: code}));
            }
        },
    };
</script>
