<template>
  <div class="grid-filters">
    <btn-filters id="channelsFiltersSort" v-model="sort" :default-sort="hasDevice && 'channelNumber'" :filters="filters" @input="filter()"></btn-filters>
    <btn-filters
      ...
      :filters="[
        ...
        {label: $t('Not available'), value: 'notAvailable'},
      ]"
      @input="filter()"
    ></btn-filters>
    <btn-filters
        ...
        if (this.search) {
          ...
          const searchString = latinize(
            [
              ...
              channel.caption,
              device.name,
              this.$t(channel.type.caption),
              location.id,
              location.caption,
              this.$t(channel.function.caption),
