<template>
  <div class="register-slider">
    ...
    <a class="register-slider-next" @click="showSlide(slideNumber + 1)">
      <i class="pe-7s-angle-right-circle"></i>
    </a>
    <a class="register-slider-prev" @click="showSlide(slideNumber - 1)">
...
<style lang="scss">
  ...
  .register-slider {
    a.register-slider-next,
    a.register-slider-prev {
      position: absolute;
      display: block;
      font-size: 60px;
