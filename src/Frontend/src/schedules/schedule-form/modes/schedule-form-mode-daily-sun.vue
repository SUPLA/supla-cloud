    ...
    <div>
        <div class="form-group">
                <span class="input-group">
                    <input type="number" class="form-control" step="5" min="0" max="200" maxlength="3"
                           v-model="sunMinute" @change="updateTimeExpression()">
        ...
        <div class="form-group">
            <div class="text-right">
                <div class="btn-group">
                    <a class="btn btn-default" @click="sunBefore = !sunBefore; updateTimeExpression()"
                       :disabled="!sunMinute">
                        <span v-show="sunBefore">{{ $t('before') }}</span>
                        <span v-show="!sunBefore">{{ $t('after') }}</span>
                    </a>
                    <a class="btn btn-default" @click="sunrise = !sunrise; updateTimeExpression()">
