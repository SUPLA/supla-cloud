...
/**
 * @ORM\Entity
 * @ORM\Table(name="supla_energy_tariff_assignment", indexes={
 *     @ORM\Index(name="idx_assignment_channel_time", columns={"channel_id", "valid_from", "valid_to"})
 * })
 */
class EnergyTariffAssignment {
    /**
     * @ORM\Id
    ...
    /**
     * @ORM\ManyToOne(targetEntity="EnergyTariff", inversedBy="assignments")
