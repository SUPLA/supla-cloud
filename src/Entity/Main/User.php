...
use App\Entity\HasRelationsCount;
use App\Entity\HasRelationsCountTrait;
...
class User implements UserInterface, EncoderAwareInterface, HasRelationsCount {
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Main\OAuth\ApiClient", mappedBy="user", cascade={"persist"})
     */
    private $apiClients;
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Main\OAuth\ApiClientAuthorization", mappedBy="user", cascade={"persist"})
     */
    ...
    /** @return \App\Entity\Main\OAuth\ApiClient[] */
    ...
    /** @return \App\Entity\Main\OAuth\ApiClientAuthorization[] */
