...
namespace App\Entity\Main\OAuth;
...
/**
 * @ORM\Entity(repositoryClass="App\Repository\ApiClientAuthorizationRepository")
...
class ApiClientAuthorization {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Main\User", inversedBy="apiClientAuthorizations")
