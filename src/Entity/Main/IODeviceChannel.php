...
use App\Entity\HasUserConfigTrait;
use App\Entity\Main\Listeners\IODeviceChannelEntityListener;
...
/**
 * @ORM\Entity(repositoryClass="App\Repository\IODeviceChannelRepository")
