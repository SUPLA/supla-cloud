  ...
  describe('timesToConditions', () => {
    const tests = [
      ...
      [
        ...
        [
          [{afterSunrise: -10}, {beforeSunrise: 10}],
          [{afterSunset: -10}, {beforeSunset: 10}],
        ],
      ],
      [
        [
        ...
        [[{beforeSunrise: 10}], [{afterSunset: -10}]],
      ],
      [[[0, 0]], []],
      ...
      [
        ...
        [[{afterSunrise: 0}, {beforeSunset: 0}], [{afterSunset: 0}], [{beforeSunrise: 0}]],
      ],
      [
        [
          [-100, 100],
        ...
        [[{afterSunrise: -40}, {beforeSunset: 40}], [{afterSunset: 40}], [{beforeSunrise: -40}]],
      ],
    ];
