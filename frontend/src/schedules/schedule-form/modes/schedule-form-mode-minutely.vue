<template>
  <div class="form-group form-group-lg">
    ...
    <div class="input-group">
      ...
      <input v-model="minutes" type="number" class="form-control" step="1" min="1" max="1000" maxlength="3" @change="updateTimeExpression()" />
      <span class="input-group-btn">
        <a class="btn btn-default btn-lg" @click="changeMultiplier()">
