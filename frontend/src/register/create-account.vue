<template>
  <div>
    <transition name="fade-router">
      <whole-screen-message v-if="registeredEmail" icon="pe-7s-mail-open-file" header-i18n="Check your email inbox" :message="registeredEmail">
        <p>
          <resend-account-activation-link :username="registeredEmail" :notifications="true"></resend-account-activation-link>
        </p>
