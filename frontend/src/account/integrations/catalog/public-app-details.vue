<template>
  <div class="container app-details-page">
    <div class="row">
      <div class="col-sm-3">
        <img class="app-image" :src="'https://www.supla.org/assets/img/AD/' + app.id" />
      </div>
      <div class="col-sm-9">
        <i18n-text :text="app.longDescription || app.description" html="true"></i18n-text>
      </div>
    </div>
    <div v-if="app.defaultScope" class="row">
      <div class="col-xs-12">
    ...
    <div class="row">
      <div class="col-sm-12 text-center">
        <a v-if="app.websiteUrl" :href="app.websiteUrl" class="btn btn-lg btn-white">
  ...
  export default {
    ...
    computed: {
      oauthLink() {
        ...
        return (
          `${server}/oauth/v2/auth?client_id=${this.app.clientId}&redirect_uri=${this.app.defaultRedirectUri}` +
