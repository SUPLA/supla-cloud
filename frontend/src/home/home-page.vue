    ...
    <div class="row">
      <div class="col-md-6 step">
        ...
        <div class="basement">
          ...
          <input v-model="suplaServerHost" type="text" readonly />
          <label>{{ $t('Server address') }}</label>
          <LoadingCover :loading="loading">
            <div v-if="location">
              <input v-model="location.id" type="text" readonly />
              <label>{{ $t('Location Identifier') }}</label>
              <input v-model="location.password" type="text" readonly />
      ...
      <div class="col-md-6 step">
        ...
        <div class="basement">
          ...
          <LoadingCover :loading="loading">
            <div v-if="accessId">
              <input v-model="accessId.id" type="text" readonly />
              <label>{{ $t('Access Identifier') }}</label>
              <input v-model="accessId.password" type="text" readonly />
...
<script>
  ...
  export default {
    ...
    mounted() {
      api
        .get('locations?include=accessids,password')
        .then((response) => {
