<template>
  <div>
      ...
      <dt>
        <div class="btn-group btn-group-flex">
          <a
            ...
            :key="number"
            :class="['btn', numberOfAttemptsToOpen == number ? 'btn-green' : 'btn-default', {'btn-attempt-1': number === 1}]"
      ...
      <dt>
        <div class="btn-group btn-group-flex">
          <a
            v-for="number in possibleNumbers"
            :key="number"
            :class="['btn', numberOfAttemptsToClose == number ? 'btn-green' : 'btn-default', {'btn-attempt-1': number === 1}]"
    ...
    <transition-expand>
      <div v-if="numberOfAttemptsToOpen === 1 || numberOfAttemptsToClose === 1" class="alert alert-warning mt-3 small">
    ...
    <dl>
      ...
      <dt>
        <div class="btn-group btn-group-flex">
          <a :class="['btn', stateVerificationMethodActive ? 'btn-green' : 'btn-default']" @click="stateVerificationMethodActive = true">
            {{ $t('channelConfig_stateVerificationMethod_active') }}
          </a>
          <a :class="['btn', !stateVerificationMethodActive ? 'btn-green' : 'btn-default']" @click="stateVerificationMethodActive = false">
