    ...
    <form @submit.prevent="saveChanges()">
      ...
      <TransitionExpand>
        <div v-if="hasPendingChanges" class="text-center mt-3">
          <FormButton button-class="btn-grey mx-1" :disabled="loading" @click="cancelChanges()">
...
<script setup>
  ...
  const availableComponents = [
    ...
    {
      title: 'MODBUS',
      component: DeviceDetailsTabSettingsModbus,
      show: props.device.config?.modbus !== undefined,
    }, // i18n
    {
      title: 'User interface', // i18n
      component: DeviceDetailsTabSettingsUserInterface,
      show:
        props.device.config?.userInterface !== undefined ||
