<template>
  <div :class="'subject-dropdown ' + (subjectType == 'channel' ? 'first-selected' : '')">
    <div class="panel-group panel-accordion m-0">
      <transition-expand>
        <div v-if="!subjectType || subjectType === 'channel'" :class="`panel panel-${subjectType === 'channel' ? 'success' : 'default'}`">
          ...
          <transition-expand>
            <div v-if="subjectType == 'channel'" class="panel-body">
              <div class="d-flex">
      ...
      <transition-expand>
        <div v-if="!subjectType || subjectType === 'channelGroup'" :class="`panel panel-${subjectType === 'channelGroup' ? 'success' : 'default'}`">
          ...
          <transition-expand>
            <div v-if="subjectType == 'channelGroup'" class="panel-body">
              <div class="d-flex">
              ...
              <ChannelGroupsDropdown v-model="subject" :filter="filter" :params="channelsDropdownParams" @input="subjectChanged($event)" />
      ...
      <transition-expand>
        <div v-if="!subjectType || subjectType === 'scene'" :class="`panel panel-${subjectType === 'scene' ? 'success' : 'default'}`">
          ...
          <transition-expand>
            <div v-if="subjectType == 'scene'" class="panel-body">
              <div class="d-flex">
              ...
              <ScenesDropdown v-model="subject" :filter="filter" @input="subjectChanged($event)" />
              <slot></slot>
            </div>
          </transition-expand>
        </div>
      ...
      <transition-expand>
        <div
          ...
          :class="`panel panel-${subjectType === 'schedule' ? 'success' : 'default'}`"
        >
          ...
          <transition-expand>
            <div v-if="subjectType == 'schedule'" class="panel-body">
              <div class="d-flex">
              ...
              <SchedulesDropdown v-model="subject" :filter="filter" @input="subjectChanged($event)" />
              <slot></slot>
            </div>
          </transition-expand>
        </div>
      ...
      <transition-expand>
        <div
          ...
          :class="`panel panel-${subjectType === 'notification' ? 'success' : 'default'}`"
        >
          ...
          <transition-expand>
            <div v-if="subjectType == 'notification'" class="panel-body">
              <slot></slot>
            </div>
          </transition-expand>
        </div>
      ...
      <transition-expand>
        <div v-if="hasOthersSlot && (!subjectType || subjectType === 'other')" :class="`panel panel-${subjectType === 'other' ? 'success' : 'default'}`">
          ...
          <transition-expand>
            <div v-if="subjectType == 'other'" class="panel-body">
              <slot v-if="subjectType == 'other'" name="other" :subject="subject" :on-input="subjectChanged"></slot>
            </div>
          </transition-expand>
        </div>
      </transition-expand>
